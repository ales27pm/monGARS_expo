...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_getBackendDevicesInfo(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->getBackendDevicesInfo(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_enableParallelMode(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->enableParallelMode(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_queueCompletion(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->queueCompletion(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_queueEmbedding(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->queueEmbedding(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt),
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_queueRerank(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->queueRerank(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt),
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_cancelRequest(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->cancelRequest(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_rerank(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->rerank(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt),
    count <= 2 ? throw jsi::JSError(rt, "Expected argument in position 2 to be passed") : args[2].asObject(rt).asArray(rt),
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_initMultimodal(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->initMultimodal(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_isMultimodalEnabled(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->isMultimodalEnabled(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_getMultimodalSupport(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->getMultimodalSupport(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_releaseMultimodal(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->releaseMultimodal(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_initVocoder(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->initVocoder(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_isVocoderEnabled(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->isVocoderEnabled(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_getFormattedAudioCompletion(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->getFormattedAudioCompletion(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt),
...
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_getAudioCompletionGuideTokens(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->getAudioCompletionGuideTokens(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_decodeAudioTokens(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->decodeAudioTokens(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt).asArray(rt)
  );
}
static jsi::Value __hostFunction_NativeRNLlamaCxxSpecJSI_releaseVocoder(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeRNLlamaCxxSpecJSI *>(&turboModule)->releaseVocoder(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
...
NativeRNLlamaCxxSpecJSI::NativeRNLlamaCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["getBackendDevicesInfo"] = MethodMetadata {0, __hostFunction_NativeRNLlamaCxxSpecJSI_getBackendDevicesInfo};
  ...
  methodMap_["enableParallelMode"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_enableParallelMode};
  methodMap_["queueCompletion"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_queueCompletion};
  methodMap_["queueEmbedding"] = MethodMetadata {3, __hostFunction_NativeRNLlamaCxxSpecJSI_queueEmbedding};
  methodMap_["queueRerank"] = MethodMetadata {4, __hostFunction_NativeRNLlamaCxxSpecJSI_queueRerank};
  methodMap_["cancelRequest"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_cancelRequest};
  methodMap_["tokenize"] = MethodMetadata {3, __hostFunction_NativeRNLlamaCxxSpecJSI_tokenize};
  ...
  methodMap_["rerank"] = MethodMetadata {4, __hostFunction_NativeRNLlamaCxxSpecJSI_rerank};
  ...
  methodMap_["initMultimodal"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_initMultimodal};
  methodMap_["isMultimodalEnabled"] = MethodMetadata {1, __hostFunction_NativeRNLlamaCxxSpecJSI_isMultimodalEnabled};
  methodMap_["getMultimodalSupport"] = MethodMetadata {1, __hostFunction_NativeRNLlamaCxxSpecJSI_getMultimodalSupport};
  methodMap_["releaseMultimodal"] = MethodMetadata {1, __hostFunction_NativeRNLlamaCxxSpecJSI_releaseMultimodal};
  methodMap_["initVocoder"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_initVocoder};
  methodMap_["isVocoderEnabled"] = MethodMetadata {1, __hostFunction_NativeRNLlamaCxxSpecJSI_isVocoderEnabled};
  methodMap_["getFormattedAudioCompletion"] = MethodMetadata {3, __hostFunction_NativeRNLlamaCxxSpecJSI_getFormattedAudioCompletion};
  methodMap_["getAudioCompletionGuideTokens"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_getAudioCompletionGuideTokens};
  methodMap_["decodeAudioTokens"] = MethodMetadata {2, __hostFunction_NativeRNLlamaCxxSpecJSI_decodeAudioTokens};
  methodMap_["releaseVocoder"] = MethodMetadata {1, __hostFunction_NativeRNLlamaCxxSpecJSI_releaseVocoder};
