...
export interface Spec extends TurboModule {
    ...
    enableParallelMode(contextId: number, params: {
        enabled: boolean;
        n_parallel?: number;
        n_batch?: number;
    }): Promise<boolean>;
    queueCompletion(contextId: number, params: NativeParallelCompletionParams): Promise<{
        requestId: number;
    }>;
    queueEmbedding(contextId: number, text: string, params: NativeEmbeddingParams): Promise<{
        requestId: number;
    }>;
    queueRerank(contextId: number, query: string, documents: Array<string>, params?: NativeRerankParams): Promise<{
        requestId: number;
    }>;
    ...
    initVocoder(contextId: number, params: {
        path: string;
        n_batch?: number;
    }): Promise<boolean>;
